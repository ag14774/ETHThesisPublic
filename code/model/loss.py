...
class MoELossTransformer(nn.Module):
    def __init__(self, loss, w_importance=1.0, w_load=1.0):
        super(MoELossTransformer, self).__init__()
        self.w_importance = w_importance
        self.w_load = w_load
        self.loss = loss['constructor'](**loss['args'])

    def forward(self, output, target):
        o, l_importance, l_load = output
        extra_loss = self.w_importance * l_importance + self.w_load * l_load
        return self.loss(o, target) + extra_loss
